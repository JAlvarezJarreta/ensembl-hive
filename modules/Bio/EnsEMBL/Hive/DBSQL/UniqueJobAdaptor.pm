...
Bio::EnsEMBL::Hive::DBSQL::UniqueJobAdaptor

=head1 SYNOPSIS

    $pipeline_wide_parameters_adaptor = $db_adaptor->get_UniqueJobAdaptor;
...
package Bio::EnsEMBL::Hive::DBSQL::UniqueJobAdaptor;
